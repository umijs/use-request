...
export async function getArtitle(): Promise<string> {
...
export async function getUserList(params: { current: number, pageSize: number, gender?: 'male' | 'female' }): Promise<{ total: number, list: UserListItem[] }> {
